...
import SCORMExport from "@/components/scorm/SCORMExport";
        ...
        <Tabs defaultValue="curriculum" className="w-full">
          ...
          <TabsContent value="resources" className="mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* SCORM Export (for mentors/admins) */}
              {(user?.role === 'mentor' || user?.role === 'admin') && courseId && (
                <div className="md:col-span-2">
                  <SCORMExport courseId={courseId} courseTitle={course.title} />
                </div>
              )}
            </div>
          </TabsContent>
